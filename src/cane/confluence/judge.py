...
adapter ไม่ใช่ของชั้นนี้ — ฝั่ง Anthropic ส่ง `temperature` ไม่ได้แล้ว (400) ฝั่ง
OpenAI-compatible ส่ง `0` ได้ · ถ้าชั้นนี้รู้จักพารามิเตอร์นั้น มันจะต้องรู้ด้วยว่า
ปลายทางเป็นใคร ซึ่งลบเหตุผลทั้งหมดของ `LlmClient` ทิ้ง
