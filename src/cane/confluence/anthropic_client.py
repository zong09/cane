...
1. **ไม่ส่ง `temperature`** — Claude ตั้งแต่ **Opus 4.7 และ Sonnet 5 ขึ้นไป** (รวม
   Opus 4.8, Opus 5, Fable 5/5.1) ถอดพารามิเตอร์นี้ออกแล้ว ส่งไปได้ 400 · **Opus 4.6
   กับ Sonnet 4.6 ยังส่งได้** — เส้นแบ่งอยู่ที่ 4.7 ไม่ใช่ 4.6 · spec/04:73 สั่งให้ตั้ง
   ต่ำสุด**เท่าที่ API รองรับ** ซึ่งที่นี่แปลว่าไม่ส่งเลย · ตัวที่รับประกันความคง
   เส้นคงวาจริงคือ cache ต่อแท่ง ไม่ใช่ค่านี้
