...
| เหตุผลของ `risk ปฏิเสธ` ระดับชั้น | `decision_risk_checks` | เป็นตารางลูก หน้านี้ไม่อ่านลูก · ของ **แท่งล่าสุด** อยู่ที่หน้าเหรียญ แท็บ การตัดสินใจ (ใบ 25) · ของแท่งเก่ายังไม่มีหน้าให้เปิด |
| ปุ่ม `ใบสรุป` · `cold start` | หน้าเหรียญ · endpoint cold start ต่อเหรียญ | `ใบสรุป` ไม่ลิงก์ไปหน้าเหรียญเพราะหน้านั้นแสดงแค่แท่งล่าสุด — คลิกจากแถวเก่าแล้วเจอคนละแท่งคือหน้าที่โกหก · endpoint cold start ยังไม่สร้าง (ใบ 25 ตัดสิน 2026-09-23) |
